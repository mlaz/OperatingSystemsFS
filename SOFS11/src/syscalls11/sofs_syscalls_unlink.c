/**
 *  \file sofs_syscalls_unlink.c (implementation file for syscall soUnlink)
 *
...
int soUnlink (const char *ePath)
{
  ...
  /** Get parent directory and entry inode numbers **/
  ...
  /** Check if ePath represents a directory **/
