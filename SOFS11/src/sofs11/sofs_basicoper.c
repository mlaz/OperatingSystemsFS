...
{
  soColorProbe (511, "07;31", "soLoadSuperBlock ()\n");
...
{
  soColorProbe (512, "07;31", "soGetSuperBlock ()\n");
...
{
  soColorProbe (513, "07;31", "soStoreSuperBlock ()\n");
...
{
  soColorProbe (514, "07;31", "soConvertRefInT (%"PRIu32", %p, %p)\n", nInode, p_nBlk, p_offset);
...
{
  soColorProbe (515, "07;31", "soLoadBlockInT (%"PRIu32")\n", nBlk);
...
{
  soColorProbe (516, "07;31", "soGetBlockInT ()\n");
...
{
  soColorProbe (517, "07;31", "soStoreBlockInT ()\n");
...
{
  soColorProbe (518, "07;31", "soConvertBPIDC (%"PRIu32", %p, %p)\n", p, p_clustInd, p_offset);
...
{
  soColorProbe (519, "07;31", "soLoadSngIndRefClust (%"PRIu32")\n", nClust);
...
{
  soColorProbe (520, "07;31", "soGetSngIndRefClust ()\n");
...
{
  soColorProbe (521, "07;31", "soStoreSngIndRefClust ()\n");
...
{
  soColorProbe (522, "07;31", "soLoadDirRefClust (%"PRIu32")\n", nClust);
...
{
  soColorProbe (523, "07;31", "soGetDirRefClust ()\n");
...
{
  soColorProbe (524, "07;31", "soStoreDirRefClust ()\n");
