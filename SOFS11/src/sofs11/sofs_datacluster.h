 ...
 *         double-linked list that forms the general repository of free data clusters (references to the previous and
 *         the next node) and its status in all cases
...
typedef struct soDataClust
{
  /* Header */
   ...
   /** \brief if the data cluster is free and resides in the general repository of free data clusters, reference to
    *         the logical number of the previous data cluster in the double-linked list; when in use, reference to
    *         NULL_CLUSTER */
    uint32_t prev;
   /** \brief if the data cluster is free and resides in the general repository of free data clusters, reference to
    *         the logical number of the next data cluster in the double-linked list; when in use, reference to
    *         NULL_CLUSTER */
    uint32_t next;
