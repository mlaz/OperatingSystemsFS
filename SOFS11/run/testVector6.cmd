...
2 0 222
6 #write inode (it is going to fail - inode 10 is free)
10 0 222
6 #write inode (it is going to fail - inode 10 is free)
10 1 222
...
2 0
5 #read inode (it is going to fail - inode 10 is free)
10 0
5 #read inode (it is going to fail - inode 10 is free)
10 1
...
2 1
8 #access granted (it is going to fail - inode 10 is free)
10 1
...
1
7 #clean inode (it is going to fail - inode 10 is free)
10
